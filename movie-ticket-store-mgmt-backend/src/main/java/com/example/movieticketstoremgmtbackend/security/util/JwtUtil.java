package com.example.movieticketstoremgmtbackend.security.util;
...
public class JwtUtil {
    ...
    static {
        try (InputStream inputStream = JwtUtil.class.getResourceAsStream("/application.properties")) {
            ...
            JwtUtil.secretKey = properties.getProperty("security.secret-key");
            JwtUtil.tokenExpirationDays = Integer.parseInt(properties.getProperty("security.token-expiration-days"));
